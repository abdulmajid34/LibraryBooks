...
return [
    ...
    */
    ...
    'email-conf'           => '提供された資格情報は、当社の記録と一致しません。',
    'exists'               => ':attribute の入力に誤りがあるか登録されていません。',
    ...
    'minute' => ':attribute は 5分以上のみ有効です。',
    'not_in'               => ':attribute 無効な値です。',
    'not_regex'            => ':attribute  無効な値です。',
    ...
    'required_if'          => ':attribute は :other が :value には必須項目です。',
    'required_unless'      => ':attribute は :other が :values でなければ必須項目です。',
    'required_with'        => ':attribute は :values が入力されている場合は必須項目です。',
    'required_with_all'    => ':attribute は :values が入力されている場合は必須項目です。',
    'required_without'     => ':attribute は :values が入力されていない場合は必須項目です。',
    'required_without_all' => ':attribute は :values が入力されていない場合は必須項目です。',
    ...
    'uuid'                 => ':attribute は正しいUUID書式のみ有効です。',
    ...
    */
    ...
    'custom' => [
        'email_address' => [
            'required' => 'メール登録は必須項目です。',
            'email' => '正しいメールアドレス書式のみ有効。',
        ],
        'password' => [
